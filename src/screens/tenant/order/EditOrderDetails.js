...
const EditOrderDetails = (route) => {
    ...
    useEffect(() => {
        console.log(route?.route?.params?.tenantId,"route")
    ...
    const submitUpdateOrderDetails = (existingBuildingId, existinAmount, existingBuildingAmount) => {
        const payload = {
            ...
            amount : existinAmount + existingBuildingAmount,
        ...
        <View style={styles.container}>
                ...
                <View style={styles.action}>
                    ...
                    <TextInput
                        ...
                        editable={false}
                        autoCorrect={false}
                        value={t.tenantDetails[0] ? t.tenantDetails[0].full_name: ""}
                        style={[
                            styles.textInput,
                            {
                                color: colors.text,
                ...
                <View style={styles.action}>
                    ...
                    <TextInput
                        ...
                        autoCorrect={false}
                        editable={false}
                        value={t.buildingDetails[0] ? t.buildingDetails[0].building_name : ""}
                        style={[
                            styles.textInput,
                            {
                                color: colors.text,
                ...
                <View style={styles.action}>
                    ...
                    <TextInput
                        ...
                        autoCorrect={false}
                        editable={false}
                        value={t.orderDetails[0] ? t.orderDetails[0].price : ""}
                        style={[
                            styles.textInput,
                            {
                                color: colors.text,
                ...
                <View style={styles.action}>
                    ...
                    <TextInput
                        ...
                        autoCorrect={false}
                        editable={false}
                        value={t.orderDetails[0].paymeny_status ? (t.orderDetails[0].paymeny_status == 'C' ? 'Success': (t.orderDetails[0].paymeny_status =='P' ? 'Pending' : 'Failure')  ) : ""}
                        style={[
                            styles.textInput,
                            {
                                color: colors.text,
                ...
                {t.orderDetails[0] && (
                    <>
                 {(t.orderDetails[0].paymeny_status== 'P') && (  
                <View >
                <View style={styles.action}>
                    ...
                    />
                     ...
                     <View>
                <TouchableOpacity style={styles.commandButton} onPress={() => {submitUpdateOrderDetails(t.buildingDetails[0] ? t.buildingDetails[0]._id: null, t.orderDetails[0] ? t.orderDetails[0].price : 0, t.buildingDetails[0] ? t.buildingDetails[0].total_amount : "") }}>
